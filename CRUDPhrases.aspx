<%@ Page MasterPageFile="~/Site1.Master" Language="C#" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" ValidateRequest="false" CodeBehind="CRUDPhrases.aspx.cs" Inherits="My_English_Training_Application_Web_Form_.CRUDPhrases" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView class="table table-striped" runat="server" ID="grid" OnRowDeleting="grid_RowDeleting" OnRowUpdating="grid_RowUpdating" OnRowCancelingEdit="grid_RowCancelingEdit" OnRowEditing="grid_RowEditing" AutoGenerateColumns="false">
        <Columns>
            <asp:TemplateField HeaderText="Phrase/Word">
                <ItemTemplate>
                    <asp:Label runat="server" ID="lblPhrase" Text='<%#Eval("PhraseOrWord") %>'></asp:Label>
                </ItemTemplate>
                <EditItemTemplate>
                    <asp:TextBox TextMode="MultiLine" CssClass="form-control" runat="server" ID="txtPhrase" Text='<%#Eval("PhraseOrWord") %>'></asp:TextBox>
                </EditItemTemplate>
            </asp:TemplateField>
